...
class OlmoeAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        mask = torch.triu(torch.ones(q_len, q_len, device=torch.device('cuda' if torch.cuda.is_available() else 'cpu')), diagonal=1)
...
class OlmoeForCausalLM(PreTrainedModel):
...
class OlmoeModel(OlmoeForCausalLM):
    """
...
class OlmoeForCausalLM(OlmoeForCausalLM, GenerationMixin):
...
__all__ = ["OlmoeForCausalLM", "OlmoeModel", "OlmoeForCausalLM"]
